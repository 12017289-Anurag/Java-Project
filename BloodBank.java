...
// Class to manage list of recipients 
class RecipientList { 
...
{ 
    ...
    int donar_age=0; 
    void fun() { 
        System.out.print("Enter name of Donar: "); 
        donar_names = sc.next(); 
        System.out.print("Enter Age of Donar: "); 
        ...
        while (true) { 
            ...
            switch (x) { 
                case 1: 
                    ...
                    n1.fun(); 
                    if(n1.donar_age<18) 
                    {System.out.println("Not Eligible I am sorry mate!");System.exit(0);} 
                    else 
                    { 
                        String name_one=n1.donar_names; 
                        int age_one=n1.donar_age; 
                        DonorList d1 = new DonorList(); 
                        d1.addDonor(Donor n1.donar_names); 
                    } 
                case 2: 
                    System.exit(0); 
            } 
        ...
        while (true) { 
            ...
            switch (choice) { 
                case 1 -> { 
                    ...
                    newDonor.bloodType = scanner.next(); 
                    System.out.print("Enter number of times donor has donated blood: "); 
                    newDonor.numDonations = scanner.nextInt(); 
